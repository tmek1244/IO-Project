...
urlpatterns = [
    ...
    path('fields-of-study-not-full-signed/<type>/',
         FieldOfStudyNotFullSignedView.as_view(),
         name='fields_of_study_not_full_signed'),
    path('fields-of-study-not-full/<int:year>/<type>/',
         FieldOfStudyNotFullView.as_view(),
         name='fields_of_study_not_full'),
    path('fields-of-study-not-full-signed/<int:year>/<type>/',
         FieldOfStudyNotFullSignedView.as_view(),
         name='fields_of_study_not_full_signed'),
    ...
    path('last-rounds/<faculty>/<field_of_study>/<degree>/<type>',
         LastRoundsView.as_view(),
         name='last-rounds'),
    path('precise-field-conversion/<int:year>/<faculty>/<field_of_study>/',
         PreciseFieldConversionView.as_view(),
         name='precise-field-conversion'),
    path('precise-field-conversion/'
